...
// @license         MIT
// @namespace       https://github.com/Sting614/corcudiscord
// @icon            https://raw.githubusercontent.com/Sting614/corcudiscord/main/sasuke.webp
// @grant           none
...
<div id="undiscord" class="browser container redact" style="display:none;">
    <div class="header">
        ...
        <span> Usa la tecla ( - ) para abrir y cerrar el menu :D</span>
        ...
        <div class="sidebar scroll">
            <details open>
                ...
                <fieldset>
                    <legend>
                        ID Autor
                        <a href="{{WIKI}}/authorId" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="multiInput">
                        <div class="input-wrapper">
                            <input class="input" id="authorId" type="text" priv>
                        </div>
                        <button id="getAuthor">yo</button>
                    </div>
                </fieldset>
                <hr>
                <fieldset>
                    <legend>
                        ID Server
                        <a href="{{WIKI}}/guildId" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="multiInput">
                        <div class="input-wrapper">
                            <input class="input" id="guildId" type="text" priv>
                        </div>
                        <button id="getGuild">actual</button>
                    </div>
                </fieldset>
                <fieldset>
                    <legend>
                        ID Canal
                        <a href="{{WIKI}}/channelId" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="multiInput mb1">
                        <div class="input-wrapper">
                            <input class="input" id="channelId" type="text" priv>
                        </div>
                        <button id="getChannel">actual</button>
                    </div>
                    <div class="sectionDescription">
                        <label class="row"><input id="includeNsfw" type="checkbox">Solo si el canal  es NSFW</label>
                    </div>
                </fieldset>
            </details>
            <details>
                <summary>Borrar Archivo</summary>
                <fieldset>
                    <legend>
                        Import index.json
                        <a href="{{WIKI}}/importJson" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="input-wrapper">
                    ...
                    <div class="sectionDescription">
                        <br>
                        Tras solicitar tus datos a Discord, puedes importarlos aquí.<br>
                        Selecciona el archivo "messages/index.json" del archivo comprimido de Discord.
                    </div>
                </fieldset>
            </details>
            <hr>
            <details>
                ...
                <fieldset>
                    <legend>
                        Buscar
                        <a href="{{WIKI}}/filters" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="input-wrapper">
                        <input id="search" type="text" placeholder="Contiene Texto" priv>
                    </div>
                    <div class="sectionDescription">
                        <br>Solo borra mensajes que contengan ese texto
                    </div>
                    <div class="sectionDescription">
                        <label><input id="hasLink" type="checkbox">contiene: link</label>
                    </div>
                    <div class="sectionDescription">
                        <label><input id="hasFile" type="checkbox">contiene: archivo</label>
                    </div>
                    <div class="sectionDescription">
                        <label><input id="includePinned" type="checkbox">Incluir fijados</label>
                    </div>
                </fieldset>
                <hr>
                <fieldset>
                    <legend>
                        Pattern
                        <a href="{{WIKI}}/pattern" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="sectionDescription">
            ...
            <details>
                <summary>Intervalo de mensajes</summary>
                <fieldset>
                    <legend>
                        Intervalo de mensajes
                        <a href="{{WIKI}}/messageId" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="multiInput mb1">
                        <div class="input-wrapper">
                            <input id="minId" type="text" placeholder="Despues de mensaje" priv>
                        </div>
                        <button id="pickMessageAfter">Elegir</button>
                    </div>
                    <div class="multiInput">
                        <div class="input-wrapper">
                            <input id="maxId" type="text" placeholder="Antes de mensaje" priv>
                        </div>
                        <button id="pickMessageBefore">Elegir</button>
                    </div>
                    <div class="sectionDescription">
                        <br>Especifica un intervalo para eliminar los mensajes.
                    </div>
                </fieldset>
            </details>
            <details>
                <summary>Intervalo de fechas</summary>
                <fieldset>
                    <legend>
                        Despues de la fecha
                        <a href="{{WIKI}}/dateRange" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    ...
                    <div class="sectionDescription">
                        <br>Elimina los mensajes que se publicaron entre esas dos fechas.
                    </div>
                    <div class="sectionDescription">
                        * El filtrado por fecha no funciona si se utiliza el "Intervalo de mensajes".
                    </div>
                </fieldset>
            </details>
            <hr>
            <details>
                ...
                <fieldset>
                    <legend>
                        Delay entre pagina (recomendado:30000ms).
                        <a href="{{WIKI}}/delay" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="input-wrapper">
                ...
                <fieldset>
                    <legend>
                        Delay entre mensaje eliminado (recomendado:1500ms).
                        <a href="{{WIKI}}/delay" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="input-wrapper">
                    ...
                    <br>
                    <div class="sectionDescription">
                        Esto afectará a la velocidad con la que se eliminan los mensajes.

                        Si los tiempos te parecen demasiado largos prueba con <br><br>Entre pagina: (10000ms)<br>Entre mensaje borrado: (450ms) <br><br> Si pones menos tiempo podria caerte un ban curioso :(
                    </div>
                </fieldset>
                <hr>
                <fieldset>
                    <legend>
                        ...
                        <a href="{{WIKI}}/authToken" title="Help" target="_blank" rel="noopener noreferrer">ayuda</a>
                    </legend>
                    <div class="multiInput">
                        <div class="input-wrapper">
                            <input class="input" id="token" type="text" autocomplete="dont" priv>
                        </div>
                        <button id="getToken">actual</button>
                    </div>
                </fieldset>
            </details>
            <hr>
        ...
        <div class="main col">
            <div class="tbar col">
                <div class="row">
                    ...
                    <button id="start" class="sizeMedium danger" style="width: 150px;" title="Start the deletion process">▶︎ Borrar Mensajes</button>
                    <button id="stop" class="sizeMedium" title="Stop the deletion process" disabled>🛑 Parar</button>
                    <button id="clear" class="sizeMedium">Limpiar log</button>
            ...
            <pre id="logArea" class="logarea scroll">
                <div class="" style="background: var(--background-mentioned); padding: .5em;">Cualquier duda escribirme a dc:c0rcu</div>
                <center>
                    <div>Comprueba <a href="{{HOME}}" target="_blank" rel="noopener noreferrer">el proyecto</a> en GitHub para saber si esta actualizado :D</div>
                    <div><a href="{{HOME}}/discussions" target="_blank" rel="noopener noreferrer">Problemas o ayuda</a></div>
                </center>
            </pre>
...
`);
	...
	class UndiscordCore {
	  ...
	  async run(isJob = false) {
	    ...
	    do {
	      ...
	      if (this.state._messagesToDelete.length > 0) {
            ...
            if (processed >= this.state.grandTotal) {
                log.verb("Processed count reached grand total. Stopping...");
                this.state.running = false;
                break;
            }
            ...
            emptyRetries = 0;
             ...
             emptyRetries++;
             log.verb(`Empty page detected. (${emptyRetries}/${maxEmptyRetries})`);
             // si pasa demasiadas veces, reiniciar el motor
             if (emptyRetries >= maxEmptyRetries) {
                 log.verb("Too many empty pages. Restarting search...");
                 // reinicio del estado de búsqueda
                 this.state.offset += Math.max(25, this.state._skippedMessages.length);
                 this.state._seachResponse = null;
	  ...
	  async confirm() {
          if (this._alreadyConfirmed) return true;
          ...
          if (answer) this._alreadyConfirmed = true;
          return answer;
      }
	  ...
	  async search() {
	    ...
	    if (resp.status === 202) {
            ...
            let w = Number(json.retry_after) * 1000;
            if (!Number.isFinite(w) || w <= 0) {
                w = this.options.searchDelay || 5000;
            }
	    ...
	    if (!resp.ok) {
	      ...
	      if (resp.status === 429) {
              ...
              // Aumentar delay, pero sin romperlo
              this.options.searchDelay = Math.min(
                  (this.options.searchDelay || 5000) + w,
                  60000
              );

              log.warn(`Being rate limited by the API for ${w}ms! Increasing search delay to ${this.options.searchDelay}ms...`);
              this.printStats();

              log.verb(`Cooling down for ${w + 1000}ms before retrying...`);
              await wait(w + 1000);
...
`;
	...
	// links
	const HOME = 'https://github.com/Sting614/corcudiscord';
	const WIKI = 'https://github.com/Sting614/corcudiscord/wiki';
...
.undiscord-window .header .close:hover {
  background: rgba(255,0,0,0.25);
}

.undiscord-window .sidebar {
...
.undiscord-window .sidebar summary {
  cursor: pointer;
  font-weight: 600;
...
.undiscord-window .sidebar fieldset {
  border: 1px solid rgba(255,255,255,0.08);
  border-radius: 12px;
  padding: 12px;
  margin-bottom: 14px;
...
.undiscord-window input,
.undiscord-window select {
...
.undiscord-window input:focus,
.undiscord-window select:focus {
  border-color: rgba(88, 101, 242, 0.7) !important;
  box-shadow: 0 0 0 3px rgba(88, 101, 242, 0.2);
}

.undiscord-window button {
...
.undiscord-window button:hover {
  transform: scale(1.03);
}

.undiscord-window button.danger {
  background: linear-gradient(135deg, #ff4d4d, #ff1a75) !important;
  color: white !important;
}

.undiscord-window button.sizeMedium {
  background: rgba(255,255,255,0.08) !important;
  color: white !important;
}

.undiscord-window button.sizeMedium:hover {
  background: rgba(255,255,255,0.14) !important;
}

.undiscord-window .main {
  background: rgba(24, 26, 32, 0.95) !important;
}

.undiscord-window .tbar {
  background: rgba(30, 33, 40, 0.95) !important;
  border-bottom: 1px solid rgba(255,255,255,0.08);
  padding: 10px 12px !important;
}

.undiscord-window #logArea {
...
.undiscord-window a:hover {
  text-decoration: underline;
}

.undiscord-window progress {
  height: 10px;
  border-radius: 20px;
  overflow: hidden;
}

.undiscord-window progress::-webkit-progress-bar {
  background: rgba(255,255,255,0.08);
}

.undiscord-window progress::-webkit-progress-value {
  background: linear-gradient(90deg, #5865f2, #00d4ff);
}

.undiscord-window label {
...
`);
      ...
      ui.undiscordWindow.classList.add("undiscord-window");
	  ...
	  function mountBtn() {
    const toolbar =
      document.querySelector('#app-mount header') ||
      document.querySelector('#app-mount [role="banner"]') ||
	...
	function waitForDiscord() {
	  ...
	  if (!mount) return setTimeout(waitForDiscord, 1000);
	  if (mount.children.length < 1) return setTimeout(waitForDiscord, 1000);

	  initUI();

	  // abrir automáticamente
	  if (ui.undiscordWindow) ui.undiscordWindow.style.display = "block";
	}
